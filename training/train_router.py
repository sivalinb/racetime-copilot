...
patterns = {
    "recap": [
        "Summarize what happened at {}.",
        "Give me a recap of {}.",
        "Catch me up on {}.",
        "What were the key moments around {}?",
        "Provide an overview of {}.",
        "Tell me the story of {}.",
    ],
    "runner": [
        "Follow Maya Chen around {}.",
        "Where is runner Lena Ortiz at {}?",
        "Track bib 214 near {}.",
        "Show Maya Chen observations from {}.",
        "Find updates for runner Lena at {}.",
        "Which clips show bib 214 at {}?",
    ],
    "verify": [
        "Verify the lead report at {}.",
        "Do the reports conflict at {}?",
        "Check whether the timing claim at {} is true.",
        "Can you confirm the commentary from {}?",
        "Is the reported gap at {} supported?",
        "Investigate conflicting evidence around {}.",
    ],
    "compare": [
        "Compare the reports from {}.",
        "What is the difference between Maya and Lena at {}?",
        "Contrast the two camera reports near {}.",
        "Compare timing versus commentary at {}.",
        "How do the two runners differ around {}?",
...
tests = {
    "recap": [
        "What happened in these fifteen minutes?",
        "Give me the highlights since the broadcast returned.",
        "I stepped away; what did I miss?",
        "Brief me on the selected video window.",
        "Explain the sequence of events in this range.",
        "What should I know before rejoining the stream?",
        "Make a chronological catch-up for this section.",
        "List the important moments from minute ten to twenty.",
        "Can I get a short race summary?",
        "Recap the last part of the broadcast.",
    ],
    "runner": [
        "Any news about bib 42?",
        "Find shots featuring Maya Chen.",
        "Where did Lena last appear?",
        "Only include updates about runner Maya.",
        "Track bib 87 through the available footage.",
        "I am crewing for Lena; show her sightings.",
        "Tell me where runner Chen was seen.",
        "Filter this clip for bib 214.",
        "Follow Lena rather than the whole field.",
        "Show the most recent mention of runner Maya.",
    ],
    "verify": [
        "Did that lead change actually happen?",
        "The announcer and timing board disagree; which claims conflict?",
        "Is the claimed arrival time backed by evidence?",
        "Can we trust that gap announcement?",
        "Check this claim against the visible timing.",
        "Are the two position reports consistent?",
        "Flag statements that cannot be confirmed.",
        "Was the leader call supported at that moment?",
        "Do we have corroboration for this report?",
        "Verify whether the graphic contradicts the commentary.",
    ],
    "compare": [
        "How did the first half differ from the second?",
        "Contrast Lena with Maya over this interval.",
        "Compare the earlier checkpoint with the later one.",
        "What differs between the visual and spoken accounts?",
        "Put the two reports next to each other.",
        "Which changes stand out across both windows?",
        "Give me the differences between these runners.",
        "Show timing and commentary side by side.",
        "Compare those two race sections.",
        "How does this segment compare with the previous one?",
    ],
}
heldout = [
...
for mode in ["frozen_encoder", "lora"]:
    ...
    optimizer = torch.optim.AdamW(
        [p for p in model.parameters() if p.requires_grad], lr=0.002
    )
    ...
    results[mode] = {
        ...
        "precision_by_label": dict(zip(LABELS, precision.tolist())),
        "recall_by_label": dict(zip(LABELS, recall.tolist())),
        "f1_by_label": dict(zip(LABELS, f1.tolist())),
...
(ROOT.parent / "reports" / "router-evaluation.json").write_text(
